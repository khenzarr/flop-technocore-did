...
- **Hosted observer:** PASS; bounded public reads, 12-second selected-room refresh, exact known-room/mailbox opening with non-discovery warnings, explicit sample/live state, responsive UI, no key custody.
